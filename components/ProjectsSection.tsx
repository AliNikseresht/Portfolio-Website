...
export function ProjectsSection({ projects, onProjectClick }: ProjectsSectionProps) {
  ...
  return (
    <section id="projects" ref={containerRef} className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900/50">
...
function ProjectCard({ project, index, onClick, scrollProgress }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="p-6">
          <h3 className="text-2xl mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
            {project.title}
          </h3>
          ...
          <div className="flex flex-wrap gap-2">
            {project.tags.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 rounded-full text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800"
              >
                {tag}
              </span>
            ))}
